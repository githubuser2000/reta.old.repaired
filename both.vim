...
tabnew
tabrewind
edit ~/workspace-noneclipse/reta/tableHandling.py
...
let s:l = 1393 - ((28 * winheight(0) + 28) / 57)
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 1797 - ((28 * winheight(0) + 28) / 57)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1797
...
set stal=1
badd +1797 reta.py
badd +1 ~/workspace-noneclipse/reta/tableHandling.py
